...
Page({
  ...
  getMsg:function() {
    ...
    for (var a = this, r = t.getQuestionsByIds(a.data.ids), n = 0; n < r.length; n++)
    ...
    if (r(), "背题模式" != n.data.textTab) {
      ...
      if (n.data.StorageAll[n.data.idarr[n.data.indexInd]]) o[n.data.current].order = n.data.StorageAll[n.data.idarr[n.data.indexInd]],
        ...
        if (c++ , t.currentTarget.dataset.ind == t.currentTarget.dataset.answer) {
          ...
          h[t.currentTarget.dataset.id] = "green", h.all = c, wx.setStorage({
          ...
          console.log(g)
          g ? (n.delCollect(), n.data.indexInd < e.length - 1 && 0 !== n.data.indexInd && n.autoPlay()) : n.data.indexInd < e.length - 1 && n.autoPlay();
